...
| 10 |Ввод в поле "Телефон" значения с префиксом +9|Невалидное значение поля "Телефон" с префиксом +9. Например, +99305558157|1. Заполнить поле "Имя" валидным значением. 2. Ввести в поле "Телефон" с префиксом +9. 3. Кликнуть на кнопку "Записаться" |Поле "Телефон" выделяется красной рамкой, под полем появляется сообщение "Неверный формат ввода номера телефона."|
...
### 3. Перечень необходимых разрешений, данных и доступов.
**Разрешения**:
* Разрешение владельцев сайта на проведение автоматизированного тестирования
...
### 4. Перечень и описание возможных рисков при автоматизации.
1. Сбой в работе сайта
2. Внесение в БД изменений
3. Отсутствие тестовых меток в структуре страницы для реализации автотестов
4. Изменение структуры страницы при уже разработанных автотестах

### 4. Перечень необходимых специалистов для автоматизации.
* Тестировщик

### 4. Интервальная оценка с учётом рисков в часах.
1. Предварительная настройка - 4
2. Написание автотестов - 12
3. Создание баг-репортов и отчетов по результатам выполнения автотестов - 4
4. Подготовка итогового отчета по автоматизации - 3
5. Подключение Continuous Integration - 3
